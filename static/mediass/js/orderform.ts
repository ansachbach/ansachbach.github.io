...
var $fancybox = (<any>$)["fancybox"];
var $orderForm = $("#order-form");
var $orderThankyou = $("#order-thankyou");

$orderForm.submit(function (e:Event) {
	e.preventDefault();
...
function getLocalISOString(i:Date):string {
	console.log(i)
	var MM: string, dd: string, hh: string, mm:string;
...
$('#order-datetime')
	//.attr("value", getLocalISOString(hoursFromNow12))
